...
import useUserProfileUpdate from "../../components/hooks/useUserProfileUpdate";
...
const ProfilePage = () => {
	...
	const memberatdata = formatMemberSinceDate(user?.createdAt)
							...
							<div className='relative group/cover'>
								...
								<div className='avatar absolute -bottom-16 left-4'>
									<div className='w-32 rounded-full relative group/avatar'>
										<img src={profileimg || user?.profileimg || "/avatar-placeholder.png"} alt ="profile img"/>
							...
							<div className='flex flex-col gap-4 mt-14 px-4'>
								...
								<div className='flex gap-2 flex-wrap'>
									...
									<div className='flex gap-2 items-center'>
										...
										<span className='text-sm text-slate-500'>{memberatdata}</span>
									</div>
								</div>
